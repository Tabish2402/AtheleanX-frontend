...
export default function Landing() {
  ...
  <Navbar />
    ...
    <div className="h-screen w-full relative flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-12 w-full text-center z-10">
        <h2 className="text-5xl md:text-5xl font-semibold tracking-widest text-white">
  ...
  className="mt-8 px-10 py-5 rounded-md bg-primary text-bg text-xl font-semibold hover:opacity-90 transition"
>
  Get Started
</button>
